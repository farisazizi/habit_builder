...
class HabitsControllerTest < ActionController::TestCase
  ...
  test "should create habit" do
    assert_difference('Habit.count') do
      post :create, habit: { days_practised: @habit.days_practised, description: @habit.description, done: @habit.done, practise_streak: @habit.practise_streak, title: @habit.title }
    end
  ...
  test "should update habit" do
    patch :update, id: @habit, habit: { days_practised: @habit.days_practised, description: @habit.description, done: @habit.done, practise_streak: @habit.practise_streak, title: @habit.title }
    assert_redirected_to habit_path(assigns(:habit))
  end
